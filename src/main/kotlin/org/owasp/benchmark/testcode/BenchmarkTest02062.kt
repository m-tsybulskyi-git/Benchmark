...
class BenchmarkTest02062 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e60435 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d60435.toByteArray())
                )
            ) // B64 encode and decode it
            val f60435 = e60435.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g60435 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g60435) // reflection
        }
    }
}