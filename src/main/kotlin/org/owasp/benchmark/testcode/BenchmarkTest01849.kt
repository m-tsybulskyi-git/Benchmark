...
class BenchmarkTest01849 : HttpServlet() {
    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        val userCookie = Cookie("BenchmarkTest01849", "someSecret")
        ...
        val rd = request.getRequestDispatcher("/hash-02/BenchmarkTest01849.html")
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e45344 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d45344.toByteArray())
                )
            ) // B64 encode and decode it
            val f45344 = e45344.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g45344 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g45344) // reflection
        }
    }
}