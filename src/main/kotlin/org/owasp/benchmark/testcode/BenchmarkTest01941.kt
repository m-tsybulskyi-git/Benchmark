...
class BenchmarkTest01941 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e20426 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d20426.toByteArray())
                )
            ) // B64 encode and decode it
            val f20426 = e20426.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g20426 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g20426) // reflection
        }
    }
}