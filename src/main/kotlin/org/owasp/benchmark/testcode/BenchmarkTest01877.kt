...
class BenchmarkTest01877 : HttpServlet() {
    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        val userCookie = Cookie("BenchmarkTest01877", "verifyUserPassword%28%27foo%27%2C%27bar%27%29")
        ...
        val rd = request.getRequestDispatcher("/sqli-04/BenchmarkTest01877.html")
