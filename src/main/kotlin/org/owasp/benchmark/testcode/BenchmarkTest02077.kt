...
class BenchmarkTest02077 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e78258 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d78258.toByteArray())
                )
            ) // B64 encode and decode it
            val f78258 = e78258.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g78258 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g78258) // reflection
        }
    }
}