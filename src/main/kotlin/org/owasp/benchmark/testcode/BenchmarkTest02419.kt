...
class BenchmarkTest02419 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e8935 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d8935.toByteArray())
                )
            ) // B64 encode and decode it
            val f8935 = e8935.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g8935 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g8935) // reflection
        }
    }
}