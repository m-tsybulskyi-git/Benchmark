...
class BenchmarkTest01854 : HttpServlet() {
    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        val userCookie = Cookie("BenchmarkTest01854", "whatever")
        ...
        val rd = request.getRequestDispatcher("/weakrand-04/BenchmarkTest01854.html")
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e34242 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d34242.toByteArray())
                )
            ) // B64 encode and decode it
            val f34242 = e34242.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g34242 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g34242) // reflection
        }
    }
}