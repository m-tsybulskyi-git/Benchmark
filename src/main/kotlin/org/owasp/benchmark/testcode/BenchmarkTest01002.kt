...
class BenchmarkTest01002 : HttpServlet() {
    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        val userCookie = Cookie("BenchmarkTest01002", "bar")
        ...
        val rd = request.getRequestDispatcher("/sqli-02/BenchmarkTest01002.html")
    ...
    public override fun doPost(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        try {
            ...
            val statement = connection.prepareStatement(sql, intArrayOf(1, 2))
