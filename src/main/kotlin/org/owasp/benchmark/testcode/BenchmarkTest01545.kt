...
class BenchmarkTest01545 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e43050 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d43050.toByteArray())
                )
            ) // B64 encode and decode it
            val f43050 = e43050.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g43050 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g43050) // reflection
        }
    } // end innerclass Test
