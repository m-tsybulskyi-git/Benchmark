...
//	    };
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e87246 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d87246.toByteArray())
                )
            ) // B64 encode and decode it
            val f87246 = e87246.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f87246) // reflection
        }
    }
}