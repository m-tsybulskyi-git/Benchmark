...
class BenchmarkTest01886 : HttpServlet() {
    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        val userCookie = Cookie("BenchmarkTest01886", "bar")
        ...
        val rd = request.getRequestDispatcher("/sqli-04/BenchmarkTest01886.html")
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e16884 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d16884.toByteArray())
                )
            ) // B64 encode and decode it
            val f16884 = e16884.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g16884 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g16884) // reflection
        }
    }
}