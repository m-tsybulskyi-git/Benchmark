...
class BenchmarkTest01204 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e40584 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d40584.toByteArray())
                )
            ) // B64 encode and decode it
            val f40584 = e40584.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f40584) // reflection
        }
    } // end innerclass Test
