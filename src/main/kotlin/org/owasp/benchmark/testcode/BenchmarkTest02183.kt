...
class BenchmarkTest02183 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e90580 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d90580.toByteArray())
                )
            ) // B64 encode and decode it
            val f90580 = e90580.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g90580 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g90580) // reflection
        }
    }
}