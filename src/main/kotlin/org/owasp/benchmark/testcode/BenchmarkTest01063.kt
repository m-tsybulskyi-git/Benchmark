...
class BenchmarkTest01063 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e92400 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d92400.toByteArray())
                )
            ) // B64 encode and decode it
            val f92400 = e92400.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f92400) // reflection
        }
    } // end innerclass Test
