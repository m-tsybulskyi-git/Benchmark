...
class BenchmarkTest01295 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e22205 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d22205.toByteArray())
                )
            ) // B64 encode and decode it
            val f22205 = e22205.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g22205 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g22205) // reflection
        }
    } // end innerclass Test
