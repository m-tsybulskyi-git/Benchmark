...
class BenchmarkTest01271 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e4086 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d4086.toByteArray())
                )
            ) // B64 encode and decode it
            val f4086 = e4086.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g4086 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g4086) // reflection
        }
    } // end innerclass Test
