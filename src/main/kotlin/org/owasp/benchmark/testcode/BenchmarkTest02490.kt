...
class BenchmarkTest02490 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e28523 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d28523.toByteArray())
                )
            ) // B64 encode and decode it
            val f28523 = e28523.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g28523 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g28523) // reflection
        }
    }
}