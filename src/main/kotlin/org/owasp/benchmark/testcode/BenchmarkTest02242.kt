...
class BenchmarkTest02242 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e91595 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d91595.toByteArray())
                )
            ) // B64 encode and decode it
            val f91595 = e91595.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g91595 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g91595) // reflection
        }
    }
}