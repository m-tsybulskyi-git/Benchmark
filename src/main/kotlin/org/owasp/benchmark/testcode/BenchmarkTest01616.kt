...
class BenchmarkTest01616 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e53857 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d53857.toByteArray())
                )
            ) // B64 encode and decode it
            val f53857 = e53857.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f53857) // reflection
        }
    } // end innerclass Test
