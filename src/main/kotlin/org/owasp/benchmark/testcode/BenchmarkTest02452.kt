...
class BenchmarkTest02452 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e91263 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d91263.toByteArray())
                )
            ) // B64 encode and decode it
            val f91263 = e91263.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g91263 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g91263) // reflection
        }
    }
}