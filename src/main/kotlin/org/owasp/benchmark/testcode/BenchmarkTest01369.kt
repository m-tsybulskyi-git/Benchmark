...
class BenchmarkTest01369 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e43860 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d43860.toByteArray())
                )
            ) // B64 encode and decode it
            val f43860 = e43860.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f43860) // reflection
        }
    } // end innerclass Test
