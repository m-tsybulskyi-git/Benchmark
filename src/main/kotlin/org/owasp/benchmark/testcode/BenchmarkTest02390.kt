...
class BenchmarkTest02390 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e73202 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d73202.toByteArray())
                )
            ) // B64 encode and decode it
            val f73202 = e73202.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g73202 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g73202) // reflection
        }
    }
}