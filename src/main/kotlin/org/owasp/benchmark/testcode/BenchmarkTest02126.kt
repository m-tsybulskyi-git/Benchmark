...
class BenchmarkTest02126 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e64181 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d64181.toByteArray())
                )
            ) // B64 encode and decode it
            val f64181 = e64181.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f64181) // reflection
        }
    }
}