...
//	    };
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e97788 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d97788.toByteArray())
                )
            ) // B64 encode and decode it
            val f97788 = e97788.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f97788) // reflection
        }
    }
}