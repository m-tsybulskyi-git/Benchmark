...
class BenchmarkTest02313 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e31085 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d31085.toByteArray())
                )
            ) // B64 encode and decode it
            val f31085 = e31085.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g31085 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g31085) // reflection
        }
    }
}