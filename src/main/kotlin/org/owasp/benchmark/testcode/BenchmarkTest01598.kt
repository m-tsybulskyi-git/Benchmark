...
class BenchmarkTest01598 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e75770 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d75770.toByteArray())
                )
            ) // B64 encode and decode it
            val f75770 = e75770.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f75770) // reflection
        }
    } // end innerclass Test
