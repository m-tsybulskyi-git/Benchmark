...
class BenchmarkTest02135 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e95930 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d95930.toByteArray())
                )
            ) // B64 encode and decode it
            val f95930 = e95930.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g95930 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g95930) // reflection
        }
    }
}