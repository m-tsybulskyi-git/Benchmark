...
class BenchmarkTest01603 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e74856 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d74856.toByteArray())
                )
            ) // B64 encode and decode it
            val f74856 = e74856.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g74856 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g74856) // reflection
        }
    } // end innerclass Test
