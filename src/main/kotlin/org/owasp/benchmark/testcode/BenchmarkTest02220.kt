...
class BenchmarkTest02220 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e19972 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d19972.toByteArray())
                )
            ) // B64 encode and decode it
            val f19972 = e19972.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f19972) // reflection
        }
    }
}