...
class BenchmarkTest02718 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e49179 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d49179.toByteArray())
                )
            ) // B64 encode and decode it
            val f49179 = e49179.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f49179) // reflection
        }
    }
}