...
class BenchmarkTest02497 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e40533 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d40533.toByteArray())
                )
            ) // B64 encode and decode it
            val f40533 = e40533.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g40533 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g40533) // reflection
        }
    }
}