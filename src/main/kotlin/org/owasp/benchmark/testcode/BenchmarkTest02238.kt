...
class BenchmarkTest02238 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e16227 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d16227.toByteArray())
                )
            ) // B64 encode and decode it
            val f16227 = e16227.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g16227 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g16227) // reflection
        }
    }
}