...
class BenchmarkTest01518 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e96602 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d96602.toByteArray())
                )
            ) // B64 encode and decode it
            val f96602 = e96602.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f96602) // reflection
        }
    } // end innerclass Test
