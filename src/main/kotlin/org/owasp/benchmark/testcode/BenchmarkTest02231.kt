...
class BenchmarkTest02231 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e60610 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d60610.toByteArray())
                )
            ) // B64 encode and decode it
            val f60610 = e60610.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g60610 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g60610) // reflection
        }
    }
}