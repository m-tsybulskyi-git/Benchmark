...
//			throw new ServletException(e);
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e2387 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d2387.toByteArray())
                )
            ) // B64 encode and decode it
            val f2387 = e2387.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g2387 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g2387) // reflection
        }
    } // end innerclass Test
