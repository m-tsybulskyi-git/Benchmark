...
class BenchmarkTest01992 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e82010 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d82010.toByteArray())
                )
            ) // B64 encode and decode it
            val f82010 = e82010.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f82010) // reflection
        }
    }
}