...
class BenchmarkTest02349 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e55770 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d55770.toByteArray())
                )
            ) // B64 encode and decode it
            val f55770 = e55770.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f55770) // reflection
        }
    }
}