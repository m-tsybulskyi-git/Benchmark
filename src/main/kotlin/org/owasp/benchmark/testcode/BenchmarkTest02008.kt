...
class BenchmarkTest02008 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e97712 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d97712.toByteArray())
                )
            ) // B64 encode and decode it
            val f97712 = e97712.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g97712 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g97712) // reflection
        }
    }
}