...
class BenchmarkTest02148 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e17988 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d17988.toByteArray())
                )
            ) // B64 encode and decode it
            val f17988 = e17988.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g17988 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g17988) // reflection
        }
    }
}