...
class BenchmarkTest02012 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e69185 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d69185.toByteArray())
                )
            ) // B64 encode and decode it
            val f69185 = e69185.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g69185 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g69185) // reflection
        }
    }
}