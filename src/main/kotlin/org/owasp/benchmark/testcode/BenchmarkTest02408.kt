...
class BenchmarkTest02408 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e67594 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d67594.toByteArray())
                )
            ) // B64 encode and decode it
            val f67594 = e67594.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g67594 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g67594) // reflection
        }
    }
}