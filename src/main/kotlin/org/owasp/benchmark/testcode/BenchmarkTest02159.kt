...
class BenchmarkTest02159 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e66015 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d66015.toByteArray())
                )
            ) // B64 encode and decode it
            val f66015 = e66015.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f66015) // reflection
        }
    }
}