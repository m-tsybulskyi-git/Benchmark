...
class BenchmarkTest02538 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e72634 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d72634.toByteArray())
                )
            ) // B64 encode and decode it
            val f72634 = e72634.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g72634 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g72634) // reflection
        }
    }
}