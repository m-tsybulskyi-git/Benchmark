...
class BenchmarkTest01502 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e43640 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d43640.toByteArray())
                )
            ) // B64 encode and decode it
            val f43640 = e43640.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g43640 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g43640) // reflection
        }
    } // end innerclass Test
