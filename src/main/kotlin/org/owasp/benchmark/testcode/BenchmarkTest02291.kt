...
//	    };
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e10347 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d10347.toByteArray())
                )
            ) // B64 encode and decode it
            val f10347 = e10347.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g10347 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g10347) // reflection
        }
    }
}