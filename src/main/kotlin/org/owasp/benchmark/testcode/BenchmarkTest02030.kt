...
class BenchmarkTest02030 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e60868 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d60868.toByteArray())
                )
            ) // B64 encode and decode it
            val f60868 = e60868.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g60868 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g60868) // reflection
        }
    }
}