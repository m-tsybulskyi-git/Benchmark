...
//	    };
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e66881 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d66881.toByteArray())
                )
            ) // B64 encode and decode it
            val f66881 = e66881.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g66881 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g66881) // reflection
        }
    } // end innerclass Test
