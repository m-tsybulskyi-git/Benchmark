...
class BenchmarkTest01844 : HttpServlet() {
    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        val userCookie = Cookie("BenchmarkTest01844", "someSecret")
        ...
        val rd = request.getRequestDispatcher("/hash-02/BenchmarkTest01844.html")
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e37183 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d37183.toByteArray())
                )
            ) // B64 encode and decode it
            val f37183 = e37183.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g37183 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g37183) // reflection
        }
    }
}