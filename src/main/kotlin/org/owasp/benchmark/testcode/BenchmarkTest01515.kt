...
class BenchmarkTest01515 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e84124 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d84124.toByteArray())
                )
            ) // B64 encode and decode it
            val f84124 = e84124.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g84124 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g84124) // reflection
        }
    } // end innerclass Test
