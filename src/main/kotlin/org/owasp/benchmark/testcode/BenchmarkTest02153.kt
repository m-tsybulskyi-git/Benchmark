...
class BenchmarkTest02153 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e82592 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d82592.toByteArray())
                )
            ) // B64 encode and decode it
            val f82592 = e82592.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g82592 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g82592) // reflection
        }
    }
}