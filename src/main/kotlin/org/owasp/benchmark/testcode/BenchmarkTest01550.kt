...
class BenchmarkTest01550 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e86153 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d86153.toByteArray())
                )
            ) // B64 encode and decode it
            val f86153 = e86153.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f86153) // reflection
        }
    } // end innerclass Test
