...
class BenchmarkTest01115 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e43762 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d43762.toByteArray())
                )
            ) // B64 encode and decode it
            val f43762 = e43762.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g43762 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g43762) // reflection
        }
    } // end innerclass Test
