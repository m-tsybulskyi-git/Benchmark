...
class BenchmarkTest02716 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e26751 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d26751.toByteArray())
                )
            ) // B64 encode and decode it
            val f26751 = e26751.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g26751 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g26751) // reflection
        }
    }
}