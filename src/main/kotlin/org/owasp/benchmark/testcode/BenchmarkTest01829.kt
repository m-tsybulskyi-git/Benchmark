...
class BenchmarkTest01829 : HttpServlet() {
    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        val userCookie = Cookie("BenchmarkTest01829", "someSecret")
        ...
        val rd = request.getRequestDispatcher("/crypto-02/BenchmarkTest01829.html")
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e60792 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d60792.toByteArray())
                )
            ) // B64 encode and decode it
            val f60792 = e60792.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f60792) // reflection
        }
    }
}