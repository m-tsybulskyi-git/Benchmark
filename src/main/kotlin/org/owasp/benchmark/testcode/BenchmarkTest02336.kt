...
class BenchmarkTest02336 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e61280 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d61280.toByteArray())
                )
            ) // B64 encode and decode it
            val f61280 = e61280.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g61280 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g61280) // reflection
        }
    }
}