...
class BenchmarkTest02423 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e24134 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d24134.toByteArray())
                )
            ) // B64 encode and decode it
            val f24134 = e24134.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f24134) // reflection
        }
    }
}