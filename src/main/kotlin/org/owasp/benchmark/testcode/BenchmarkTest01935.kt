...
class BenchmarkTest01935 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e17785 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d17785.toByteArray())
                )
            ) // B64 encode and decode it
            val f17785 = e17785.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f17785) // reflection
        }
    }
}