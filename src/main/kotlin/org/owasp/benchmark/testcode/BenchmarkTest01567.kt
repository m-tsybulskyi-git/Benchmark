...
//			throw new ServletException(e);
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e29366 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d29366.toByteArray())
                )
            ) // B64 encode and decode it
            val f29366 = e29366.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g29366 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g29366) // reflection
        }
    } // end innerclass Test
