...
//	    };
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e27056 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d27056.toByteArray())
                )
            ) // B64 encode and decode it
            val f27056 = e27056.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g27056 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g27056) // reflection
        }
    } // end innerclass Test
