...
class BenchmarkTest01458 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e34936 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d34936.toByteArray())
                )
            ) // B64 encode and decode it
            val f34936 = e34936.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f34936) // reflection
        }
    } // end innerclass Test
