...
class BenchmarkTest02351 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e14991 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d14991.toByteArray())
                )
            ) // B64 encode and decode it
            val f14991 = e14991.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f14991) // reflection
        }
    }
}