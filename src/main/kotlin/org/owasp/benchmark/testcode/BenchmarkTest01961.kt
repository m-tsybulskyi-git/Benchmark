...
class BenchmarkTest01961 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e99523 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d99523.toByteArray())
                )
            ) // B64 encode and decode it
            val f99523 = e99523.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g99523 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g99523) // reflection
        }
    }
}