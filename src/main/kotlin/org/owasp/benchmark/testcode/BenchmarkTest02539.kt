...
class BenchmarkTest02539 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e9290 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d9290.toByteArray())
                )
            ) // B64 encode and decode it
            val f9290 = e9290.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g9290 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g9290) // reflection
        }
    }
}