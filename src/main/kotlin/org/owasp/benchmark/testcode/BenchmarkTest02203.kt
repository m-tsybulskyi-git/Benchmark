...
class BenchmarkTest02203 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e31470 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d31470.toByteArray())
                )
            ) // B64 encode and decode it
            val f31470 = e31470.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g31470 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g31470) // reflection
        }
    }
}