...
class BenchmarkTest00782 : HttpServlet() {
    ...
    public override fun doPost(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        if (paramLoc == -1) {
            response.writer.println("getQueryString() couldn't find expected parameter '" + "BenchmarkTest00782" + "' in query string.")
            return
        }
        var param =
            queryString!!.substring(paramLoc + paramval.length) // 1st assume "BenchmarkTest00782" param is last parameter in query string.
        ...
        try {
            val c = Cipher.getInstance("AES/CCM/NoPadding", Security.getProvider("BC"))
