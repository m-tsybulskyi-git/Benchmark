...
class BenchmarkTest02081 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e44156 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d44156.toByteArray())
                )
            ) // B64 encode and decode it
            val f44156 = e44156.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f44156) // reflection
        }
    }
}