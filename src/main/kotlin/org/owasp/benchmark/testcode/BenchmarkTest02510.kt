...
class BenchmarkTest02510 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e11776 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d11776.toByteArray())
                )
            ) // B64 encode and decode it
            val f11776 = e11776.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g11776 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g11776) // reflection
        }
    }
}