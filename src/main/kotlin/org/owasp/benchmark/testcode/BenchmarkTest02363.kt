...
class BenchmarkTest02363 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e21456 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d21456.toByteArray())
                )
            ) // B64 encode and decode it
            val f21456 = e21456.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g21456 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g21456) // reflection
        }
    }
}