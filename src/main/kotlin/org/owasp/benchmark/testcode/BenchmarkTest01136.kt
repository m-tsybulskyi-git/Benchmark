...
class BenchmarkTest01136 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e58606 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d58606.toByteArray())
                )
            ) // B64 encode and decode it
            val f58606 = e58606.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g58606 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g58606) // reflection
        }
    } // end innerclass Test
