...
class BenchmarkTest01569 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e75250 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d75250.toByteArray())
                )
            ) // B64 encode and decode it
            val f75250 = e75250.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g75250 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g75250) // reflection
        }
    } // end innerclass Test
