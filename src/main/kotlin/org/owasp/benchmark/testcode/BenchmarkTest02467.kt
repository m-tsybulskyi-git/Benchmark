...
class BenchmarkTest02467 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e60326 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d60326.toByteArray())
                )
            ) // B64 encode and decode it
            val f60326 = e60326.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g60326 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g60326) // reflection
        }
    }
}