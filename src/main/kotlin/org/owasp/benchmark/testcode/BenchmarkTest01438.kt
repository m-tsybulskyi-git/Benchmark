...
class BenchmarkTest01438 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e32762 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d32762.toByteArray())
                )
            ) // B64 encode and decode it
            val f32762 = e32762.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f32762) // reflection
        }
    } // end innerclass Test
