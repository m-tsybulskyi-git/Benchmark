...
class BenchmarkTest01591 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e1207 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d1207.toByteArray())
                )
            ) // B64 encode and decode it
            val f1207 = e1207.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g1207 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g1207) // reflection
        }
    } // end innerclass Test
