...
class BenchmarkTest01841 : HttpServlet() {
    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        val userCookie = Cookie("BenchmarkTest01841", "FileName")
        ...
        val rd = request.getRequestDispatcher("/pathtraver-02/BenchmarkTest01841.html")
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e14546 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d14546.toByteArray())
                )
            ) // B64 encode and decode it
            val f14546 = e14546.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g14546 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g14546) // reflection
        }
    }
}