...
class BenchmarkTest02674 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e73069 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d73069.toByteArray())
                )
            ) // B64 encode and decode it
            val f73069 = e73069.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g73069 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g73069) // reflection
        }
    }
}