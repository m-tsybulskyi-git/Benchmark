...
class BenchmarkTest01217 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e89502 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d89502.toByteArray())
                )
            ) // B64 encode and decode it
            val f89502 = e89502.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g89502 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g89502) // reflection
        }
    } // end innerclass Test
