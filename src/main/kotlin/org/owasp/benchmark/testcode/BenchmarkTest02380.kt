...
class BenchmarkTest02380 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e76789 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d76789.toByteArray())
                )
            ) // B64 encode and decode it
            val f76789 = e76789.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g76789 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g76789) // reflection
        }
    }
}