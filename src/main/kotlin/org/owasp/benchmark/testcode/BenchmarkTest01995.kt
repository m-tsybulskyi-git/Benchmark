...
class BenchmarkTest01995 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e33633 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d33633.toByteArray())
                )
            ) // B64 encode and decode it
            val f33633 = e33633.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g33633 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g33633) // reflection
        }
    }
}