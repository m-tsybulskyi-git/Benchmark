...
class BenchmarkTest01378 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e50098 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d50098.toByteArray())
                )
            ) // B64 encode and decode it
            val f50098 = e50098.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g50098 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g50098) // reflection
        }
    } // end innerclass Test
