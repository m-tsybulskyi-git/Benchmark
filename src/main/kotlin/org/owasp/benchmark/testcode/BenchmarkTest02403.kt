...
class BenchmarkTest02403 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e34270 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d34270.toByteArray())
                )
            ) // B64 encode and decode it
            val f34270 = e34270.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f34270) // reflection
        }
    }
}