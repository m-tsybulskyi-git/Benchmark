...
//	    };
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e37227 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d37227.toByteArray())
                )
            ) // B64 encode and decode it
            val f37227 = e37227.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g37227 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g37227) // reflection
        }
    } // end innerclass Test
