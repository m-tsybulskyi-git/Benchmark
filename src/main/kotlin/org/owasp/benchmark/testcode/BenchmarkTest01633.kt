...
class BenchmarkTest01633 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e31144 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d31144.toByteArray())
                )
            ) // B64 encode and decode it
            val f31144 = e31144.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g31144 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g31144) // reflection
        }
    } // end innerclass Test
