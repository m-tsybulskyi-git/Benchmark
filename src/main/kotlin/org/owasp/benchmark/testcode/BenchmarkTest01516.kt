...
class BenchmarkTest01516 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e84214 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d84214.toByteArray())
                )
            ) // B64 encode and decode it
            val f84214 = e84214.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g84214 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g84214) // reflection
        }
    } // end innerclass Test
