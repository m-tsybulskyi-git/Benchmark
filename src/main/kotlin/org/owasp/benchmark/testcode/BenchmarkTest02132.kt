...
class BenchmarkTest02132 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e76744 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d76744.toByteArray())
                )
            ) // B64 encode and decode it
            val f76744 = e76744.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f76744) // reflection
        }
    }
}