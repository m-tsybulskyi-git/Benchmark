...
//	    };
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e50268 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d50268.toByteArray())
                )
            ) // B64 encode and decode it
            val f50268 = e50268.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f50268) // reflection
        }
    }
}