...
class BenchmarkTest01931 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e40465 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d40465.toByteArray())
                )
            ) // B64 encode and decode it
            val f40465 = e40465.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f40465) // reflection
        }
    }
}