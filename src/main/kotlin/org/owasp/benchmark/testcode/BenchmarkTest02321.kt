...
class BenchmarkTest02321 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e32510 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d32510.toByteArray())
                )
            ) // B64 encode and decode it
            val f32510 = e32510.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f32510) // reflection
        }
    }
}