...
class BenchmarkTest02477 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e40743 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d40743.toByteArray())
                )
            ) // B64 encode and decode it
            val f40743 = e40743.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g40743 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g40743) // reflection
        }
    }
}