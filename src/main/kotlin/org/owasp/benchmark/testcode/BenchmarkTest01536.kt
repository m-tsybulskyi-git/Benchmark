...
class BenchmarkTest01536 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e79311 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d79311.toByteArray())
                )
            ) // B64 encode and decode it
            val f79311 = e79311.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g79311 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g79311) // reflection
        }
    } // end innerclass Test
