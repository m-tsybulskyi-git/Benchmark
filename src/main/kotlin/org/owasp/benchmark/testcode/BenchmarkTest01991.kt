...
class BenchmarkTest01991 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e81108 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d81108.toByteArray())
                )
            ) // B64 encode and decode it
            val f81108 = e81108.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g81108 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g81108) // reflection
        }
    }
}