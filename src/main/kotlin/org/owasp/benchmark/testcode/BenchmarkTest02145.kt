...
class BenchmarkTest02145 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e32743 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d32743.toByteArray())
                )
            ) // B64 encode and decode it
            val f32743 = e32743.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f32743) // reflection
        }
    }
}