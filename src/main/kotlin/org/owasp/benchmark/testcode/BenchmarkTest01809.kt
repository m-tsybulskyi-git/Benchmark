...
class BenchmarkTest01809 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e64594 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d64594.toByteArray())
                )
            ) // B64 encode and decode it
            val f64594 = e64594.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g64594 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g64594) // reflection
        }
    } // end innerclass Test
