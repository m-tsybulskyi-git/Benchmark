...
class BenchmarkTest02396 : HttpServlet() {
    ...
    companion object {
        ...
        private fun doSomething(request: HttpServletRequest, param: String): String {
            ...
            val e53479 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d53479.toByteArray())
                )
            ) // B64 encode and decode it
            val f53479 = e53479.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f53479) // reflection
        }
    }
}