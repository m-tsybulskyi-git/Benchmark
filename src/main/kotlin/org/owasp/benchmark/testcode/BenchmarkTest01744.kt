...
class BenchmarkTest01744 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e17402 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d17402.toByteArray())
                )
            ) // B64 encode and decode it
            val f17402 = e17402.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            val g17402 = "barbarians_at_the_gate" // This is static so this whole flow is 'safe'
            return thing.doSomething(g17402) // reflection
        }
    } // end innerclass Test
