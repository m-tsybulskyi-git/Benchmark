...
class BenchmarkTest01800 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e71684 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d71684.toByteArray())
                )
            ) // B64 encode and decode it
            val f71684 = e71684.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f71684) // reflection
        }
    } // end innerclass Test
