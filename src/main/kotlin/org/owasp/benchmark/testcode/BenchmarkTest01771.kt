...
class BenchmarkTest01771 : HttpServlet() {
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e58724 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d58724.toByteArray())
                )
            ) // B64 encode and decode it
            val f58724 = e58724.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f58724) // reflection
        }
    } // end innerclass Test
