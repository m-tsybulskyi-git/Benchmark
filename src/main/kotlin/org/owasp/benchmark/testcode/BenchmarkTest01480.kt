...
//	    };
    ...
    private inner class Test {
        ...
        fun doSomething(request: HttpServletRequest?, param: String): String {
            ...
            val e55670 = String(
                Base64.decodeBase64(
                    Base64.encodeBase64(d55670.toByteArray())
                )
            ) // B64 encode and decode it
            val f55670 = e55670.split(" ".toRegex()).toTypedArray()[0] // split it on a space
            val thing = ThingFactory.createThing()
            return thing.doSomething(f55670) // reflection
        }
    } // end innerclass Test
